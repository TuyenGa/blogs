...
Scope bao gồm các phần của ứng dụng bị ảnh hưởng bởi commit này. Nó có thể là một phần của ứng dụng hoặc là một module của ứng dụng. Nếu commit ảnh hưởng đến nhiều phần của ứng dụng thì scope có thể là `*`. Nếu commit ảnh hưởng đến nhiều module thì scope có thể là `*`.
